...
module.exports = {
  TOKEN: "",
  language: "en",
  ownerID: ["1394839773046247455", ""], 
  mongodbUri : "mongodb+srv://saggaraaryan311_db_user:<AARYAN_IS_LIVE>@cluster0.kbqoz46.mongodb.net/?appName=Cluster0",
  spotifyClientId : "d92baed9605a45a39ed7c2a2d960b1c1",
  spotifyClientSecret : "e9b29f6739de4315bc03b6d8a8e93b03",
  setupFilePath: './commands/setup.json',
  commandsDir: './commands',  
  embedColor: "#1db954",
  activityName: "Aaryan Music", 
